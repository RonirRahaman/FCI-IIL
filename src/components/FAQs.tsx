...
const faqs = [
  { q: 'How fast can I get funded?', a: 'Approvals in days - depending on documentation.' },
  ...
  return (
    <section className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 overflow-hidden">
      ...
      >
        ...
        <p className="mt-3 text-black/80">Answers to common questions.</p>
      </motion.div>
      <div className="mt-8 space-y-3">
        {faqs.map((f, i) => (
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            className="rounded-xl bg-black/5 border border-black/10"
          >
