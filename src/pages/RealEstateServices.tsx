...
function RealEstateServices() {
  const services = [
    ...
    },
    {
      ...
      description: "FCI delivers architectural and engineering design services that balance creativity with compliance and efficiency. From design concepts to technical construction documents, we ensure functionality and cost-effectiveness. Our solutions enhance project aesthetics while maintaining structural integrity. This makes us a trusted partner for innovative developments.",
    ...
    <div className="pt-20">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 space-y-20">
        <header className="text-center">
          <Reveal delay={0}>
            <h1 className="text-4xl lg:text-5xl font-extrabold text-black mb-6">Real Estate & Development Services</h1>
        ...
        <section id="booking" className="rounded-xl bg-black/5 border border-black/10 p-8 lg:p-12">
          <Reveal delay={0}>
            <div className="text-center mb-8">
              <h2 className="text-3xl lg:text-4xl font-bold text-black mb-4">Ready to Start Your Project?</h2>
